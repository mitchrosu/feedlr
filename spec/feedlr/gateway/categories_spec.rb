...
describe Feedlr::Gateway::Categories, vcr: { record: :new_episodes } do
  ...
  describe '#user_categories' do
    it 'sends a get request' do
      stub = stub_request(:get, 'http://sandbox7.feedly.com/v3/categories')
  ...
  describe '#change_category_label' do
    ...
    it 'sends a post request' do
      stub = stub_request(:post, 'http://sandbox7.feedly.com/v3/categories/'\
  ...
  describe '#delete_category'  do
    ...
    it 'sends a delete request' do
      stub = stub_request(:delete, 'http://sandbox7.feedly.com/v3/categories/'\
        "#{CGI.escape(category_id)}")
